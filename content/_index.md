...
features:
  ...
  features_blocks:
    ...
    - icon: "👻"
      title: "Ghost Versions & Incomplete Uploads"
      content: "Find and remove non-current object versions, delete markers, and incomplete multipart uploads that silently add up to significant hidden storage overhead."
    - icon: "🛡️"
    ...
    - icon: "🤖"
      title: "MCP Server"
      content: "Expose optimization reports directly to AI assistants. Connect tools like Claude Desktop or Amazon Q to audit S3 storage costs using natural language."
    - icon: "☁️"
      title: "Native to AWS"

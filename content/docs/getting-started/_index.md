...
To help you get started, we offer four main deployment modes:
...
4. **[Multi-Region Mode (StackSets)]({{< relref "multi-region.md" >}})**: Best if you want to deploy `s3lim` across multiple regions and accounts simultaneously using AWS CloudFormation StackSets.

...
To help you get started, we offer the following deployment modes:
...
2. **[Standard Mode]({{< relref "standard.md" >}})**: Best if you already have S3 Inventory reports configured and delivered to a bucket. Supports both automated Managed IAM and custom Bring-Your-Own-IAM (BYO-IAM) roles.
...
4. **[Execution Modes]({{< relref "execution-modes.md" >}})**: Detailed guide on choosing and sizing between Fast Mode (single-Lambda) and Distributed Mode (Step Functions Distributed Map).
